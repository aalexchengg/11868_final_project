...
from tuning.custom_qwen.qwen2_5._component_builders import (
    lora_propulsion_qwen2,
    propulsion_qwen2,
)
...
def lora_qwen2_5_0_5b(
    ...
    Args:
        ...
        apply_prop_to_mlp (bool): whether to apply Propulsion to the MLP in each transformer layer.
            Default: False
        apply_prop_to_output (bool): whether to apply Propulsion to the output projection.
            Default: False
        prop_degree (int): degree of the Propulsion polynomial. Default: 15

    Returns:
        TransformerDecoder: Instantiation of Qwen2.5 0.5B model with LoRA and Propulsion applied

    Note:
        Qwen2.5 0.5B-3B model builders will enable ``tie_word_embeddings`` by default (see :func:`~torchtune.models.qwen2.qwen2`)
    """
    return lora_propulsion_qwen2(
